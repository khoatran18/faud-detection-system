...
from model_monitor.generate_data import generate_data
...
def run_producer():
    ...
    logger.info("[Monitor] Start ingestion...")
    ...
    try:
        ...
        for idx, record in enumerate(rows, start=1):
            ...
            if total_records % 100 == 0:
                logger.info(f"[Monitor] Processed {total_records} records")

    except Exception as e:
        logger.error("[Monitor] Error when ingestion: %s", e)
